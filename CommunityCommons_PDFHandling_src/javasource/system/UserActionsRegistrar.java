...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(coco_pdfhandling.actions.MergeMultiplePdfs.class);
			component.actionRegistry().registerUserAction(coco_pdfhandling.actions.OverlayPdfDocument.class);
