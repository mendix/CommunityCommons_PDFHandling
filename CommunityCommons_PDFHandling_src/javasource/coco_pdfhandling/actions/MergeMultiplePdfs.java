...
package coco_pdfhandling.actions;

import com.mendix.systemwideinterfaces.core.IContext;
import com.mendix.systemwideinterfaces.core.IMendixObject;
import com.mendix.webui.CustomJavaAction;
import coco_pdfhandling.PDFHandling;
...
public class MergeMultiplePdfs extends CustomJavaAction<Boolean>
{
	...
	public Boolean executeAction() throws Exception
	{
		...
		// BEGIN USER CODE
		return PDFHandling.mergePDF(this.getContext(), this.FilesToMerge, this.MergedDocument.getMendixObject());
		// END USER CODE
	}
